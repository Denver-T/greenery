  ...
  return (
    <header className="flex items-center justify-between border-b border-border-soft/80 bg-surface/90 px-8 backdrop-blur dark:border-white/10 dark:bg-[#23262de0]">
      <div>
        ...
        <h1 className="mt-1 text-[24px] font-black tracking-tight text-[#1f3427] dark:text-[#f1ece3]">
          {title ?? "Page Title"}
        </h1>
      </div>
      ...
      <div className="flex items-center gap-3">
        <ThemeToggle />
        <div className="hidden rounded-full border border-border-soft bg-surface-muted px-3 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-muted dark:border-white/10 dark:bg-white/5 dark:text-slate-300 md:block">
          Live Workspace
        </div>
        <button
