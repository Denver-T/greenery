        ...
        >
          <div className="mb-6">
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6 text-gray-600">
              Keep the account details current so your identity looks consistent
              across the app.
            </p>
          </div>
          ...
          <div className="grid gap-6">
            <FormField
              label="Display Name"
              hint="Shown in the workspace and profile previews."
            >
              <input
            ...
            <FormField
              label="Email Address"
              hint="Managed by authentication and currently read-only."
            >
              <input
            ...
            <FormField
              label="Photo URL"
              hint="Paste a direct image URL for your profile avatar."
            >
              <input
                className="rounded-xl border border-border-soft bg-white px-3 py-2.5 text-gray-800 outline-none focus:ring-2 focus:ring-brand/30"
                value={photoURL}
        ...
        <div className="space-y-5">
          <div className="rounded-card border border-border-soft bg-surface p-6 shadow-soft">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Use these actions when you need to leave the workspace or navigate
              back to operations.
            </p>
