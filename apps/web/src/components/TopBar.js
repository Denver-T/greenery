  ...
  return (
    <header className="flex items-center justify-between gap-3 border-b border-border-soft/80 bg-surface/90 px-4 md:px-6 lg:px-8 backdrop-blur dark:border-white/10 dark:bg-[#23262de0]">
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        {/* Notification bell intentionally omitted — backend notifications
            service not yet implemented. Will be re-added once /notifications
            endpoint + read/unread state are in place. */}
        <TopBarUserMenu />
      </div>
    </header>
  );
